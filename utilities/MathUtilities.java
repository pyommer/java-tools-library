...
public class MathUtilities
{
    ...
    /**
     * This method returns the sum of a simple geometric progression,
     * where every two consecutive elements have the same ratio.
     *
     * Time complexity:     O(1)
     * Space complexity:    O(1)
     *
     ...
     * @return  The summation:    (n choose 0) + (n choose 1) + ...
     *                          + (n choose n)
     */
    ...
    /**
     * This method returns the summation of (n choose k)*x^(n-k)*y^k over
     * k in [0, n], according to the binomial theorem.
     *
     * Time complexity:     O(1)
     * Space complexity:    O(1)
     *
     ...
     * @param y The y value.
     * @param n The number of choices.
     * @return  The summation:    (n choose 0)*x^(n-0)*y^0 + ...
     *                          + (n choose 1)*x^(n-1)*y^1 + ...
     *                          +   ...
     *                          + (n choose n)*x^(n-n)*y^n
     */
    ...
    /**
     * This method returns the choose value for the specified integers,
    ...
    /**
     * This method returns the factorial value of the specified integer,
     * using an iterative programming approach.
     *
     * Time complexity:     O(n)
     * Space complexity:    O(1)
     *
    ...
    /**
     * This method returns the choose value for the specified integers,
     * using a dynamic iterative programming approach.
     *
     * Time complexity:     O(n)
     * Space complexity:    O(1)
     *
     ...
     * integers, according to Euclid's recursive algorithm for GCD,
     * using a dynamic iterative programming approach.
     *
     * Time complexity:     O(n)
     * Space complexity:    O(1)
    ...
    /**
     * This method returns the n-th Fibonacci number, using an iterative
     * dynamic programming approach. The Fibonacci sequence used starts
     * with 0.
     *
     * Time complexity:     O(n)
    ...
    /**
     * This method returns the n-th Fibonacci number, using a memoized
     * dynamic programming approach. The Fibonacci sequence used starts
     * with 0.
     *
     * Time complexity:     O(2^n)
     * Space complexity:    O(n)
     *
     * @param n     The ordinal of the desired number in the Fibonacci
     *              sequence.
    ...
    /**
     * This method returns the n-th row of Pascal's triangle, using an
     ...
     * @return  The n-th row of Pascal's triangle, or null if n is out of
     *          bounds.
     */
    ...
    /**
     * This method returns true if the specified integers are relatively
     * prime.
     *
     * Time complexity:     O(n)
     * Space complexity:    O(1)
    ...
    /**
     * This method returns the magic square constant for a magic square
     * of the specified order. The magic square constant is defined as
     * the summation of integers in [1, n^2] divided by n, where n is
    ...
    /**
     * This method returns the minimum and maximum sum of n-1 of the
     * integers in the specified array of n integers.
     *
     * Time complexity:     O(n)
     * Space complexity:    O(1)
     *
     ...
     * elements in the array. If there are no non-adjacent subsets, zero
     * is returned.
     *
     * Time complexity:     O(n)
     * Space complexity:    O(1)
    ...
    /**
     * This method returns the 1-based indices of the first two values in
     * the array that sum to the specified value. If no two values sum to
     * the sum, zero is returned for both indices.
     *
     * Time complexity:     O(n)
     * Space complexity:    O(n)
     *
    ...
    /**
     * This method returns the minimum sum of the rank of each element in
     * the specified array, where the rank of each element is determined
     * only by its adjacent elements.
     *
     * Time complexity:     O(n^2)  ??
     * Space complexity:    O(n)    ??
     *
    ...
    /**
     * This method returns the length of the shortest path between two
     * nodes of the same value, or -1 if no such nodes exist.
     *
     * Time complexity:     O(n^2)  ??
     * Space complexity:    O(n^2)  ??
     *
    ...
    /**
     * This method returns the value of the shortest path between two
     * nodes of the same value, or -1 if no such nodes exist.
     *
     * Time complexity:     O(n^2)  ??
     * Space complexity:    O(n^2)  ??
    ...
    /**
     * This method returns the length of the shortest path between two
     * nodes of the same specified value, or -1 if no such nodes exist.
     *
     * Time complexity:     O(n^2)  ??
     * Space complexity:    O(n^2)  ??
     *
     ...
     * @param to    An array of integers, the end nodes for each edge.
     * @param ids   An array of integers, the value id per node.
     * @return  The length of the shortest path between two nodes of
     *          the same value.
     */
    ...
    /**
     * This method builds and traverses the tree for the specified mode
     * of traversal, the tree edges, and the node values.
     *
    ...
    /**
     * This method prints the nodes of the tree with the specified root
     * in a depth-first, inorder traversal. Assumes this is a binary
     * tree.
     *
     * Time complexity:     O(n)
     * Space complexity:    O(n)
    ...
    /**
     * This method prints the nodes of the tree with the specified root
     * in a depth-first, preorder traversal. Assumes this is a binary
     *      * tree.
     *
     * Time complexity:     O(n)
     * Space complexity:    O(n)
    ...
    /**
     * This method prints the nodes of the tree with the specified root
     * in a depth-first, postorder traversal. Assumes this is a binary
     *      * tree.
     *
     * Time complexity:     O(n)
     * Space complexity:    O(n)
    ...
    /**
     * This method returns the sorted array by performing a quicksort on
     * the specified array.
     *
    ...
    /**
     * This method returns the sorted array by performing a mergesort on
     * the specified array.
     *
    ...
    /**
     * This method returns the sorted array by performing a heapsort on
     * the specified array.
     *
     *  Worst-case performance: O(n*log(n))
    ...
    /**
     * This method performs the heapify step for heapsort and returns
     * the heapified array.
     *
